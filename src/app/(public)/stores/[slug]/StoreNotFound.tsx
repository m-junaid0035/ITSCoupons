...
export default function StoreNotFound() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-purple-800 to-purple-600 text-white relative overflow-hidden px-4">
      ...
      <p className="text-lg sm:text-xl md:text-2xl mb-8 max-w-lg text-center relative z-10">
        Oops! The store you’re looking for doesn’t exist or has been moved.
      </p>

      {/* Rocket Icon */}
      <Rocket className="w-12 h-12 animate-bounce mb-6 relative z-10" />

      {/* Button to go back to stores */}
      <Button
