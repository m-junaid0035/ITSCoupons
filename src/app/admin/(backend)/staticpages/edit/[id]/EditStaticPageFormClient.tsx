...
import { updateStaticPageAction } from "@/actions/staticPagesActions";
...
export default function EditStaticPageFormClient({
  pageId,
  initialPage,
}: Props) {
  ...
  const [contentHtml, setContentHtml] = useState(initialPage?.content ?? "");
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                name="isPublished"
                value="true"
                defaultChecked={!!initialPage.isPublished}
                className="w-4 h-4"
              />
