...
import { deleteStaticPageAction } from "@/actions/staticPagesActions";
...
import StaticPageModal from "@/components/views/StaticPageModal";
...
// ================== Client Page ==================
export default function StaticPagesPageClient({
  initialPages,
}: {
  initialPages: IStaticPage[];
}) {
  const router = useRouter();
  const [pages, setPages] = useState<IStaticPage[]>(initialPages);
  ...
  const handleDelete = async (id: string) => {
    ...
    if (result?.error) {
      ...
      setPages(initialPages); // rollback
    } else {
