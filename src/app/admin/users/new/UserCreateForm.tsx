    ...
    <>
          ...
          <form action={dispatch} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" name="password" type="password" required
                ...
                className="border-none shadow-sm bg-gray-50 dark:bg-gray-700" />
              {errorFor("password") && <p className="text-sm text-red-500">{errorFor("password")}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errorFor("isActive") && <p className="text-sm text-red-500">{errorFor("isActive")}</p>}
            </div>
      ...
      <Dialog open={successDialogOpen} onOpenChange={setSuccessDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button onClick={() => { setSuccessDialogOpen(false); router.push("/admin/users"); }}>
              OK
            </Button>
          </DialogFooter>
        </DialogContent>
