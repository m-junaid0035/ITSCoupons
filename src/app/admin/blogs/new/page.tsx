      ...
      <CardContent>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <Input id="image" name="image" placeholder="https://example.com/image.jpg" className="border-none shadow-sm" />
            {errorFor("image") && (
          ...
          <div className="space-y-2">
            ...
            <Input id="focusKeywords" name="focusKeywords" className="border-none shadow-sm" />
